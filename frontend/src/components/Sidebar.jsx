...
import { FiHome, FiTrendingUp, FiAppleAlt, FiCalendar, FiMessageCircle, FiCamera, FiUser, FiLogOut, FiMenu, FiX } from 'react-icons/fi';
...
export default function Sidebar() {
  ...
  const menuItems = [
    ...
    { path: '/nutrition', label: 'Nutrition', icon: FiAppleAlt },
